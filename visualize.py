...
test_loader = torch.utils.data.DataLoader(
        GestaltMNIST('./MNIST/illusory_edge_225/', transform=transforms.Compose([transforms.ToTensor(),])),batch_size=5, shuffle=False)
for image, label in test_loader:
    ...
    plt.axis('off') 
    plt.savefig('MNIST_illusory_edge_225.jpg')
    break